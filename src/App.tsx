...
export function App() {
  ...
  return (
    <div className="bg-natureBlue h-screen flex items-center justify-center">
      <form onSubmit={handleSignIn} className="bg-transWhite min-h-min min-w-min rounded-4xl flex flex-col items-center divide-x-0 md:flex-row md:divide-x md:w-2/3 md:h-120 py-6">
